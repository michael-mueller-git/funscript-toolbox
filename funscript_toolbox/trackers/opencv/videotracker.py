...
class StaticVideoTrackerParameter:
    tracking_init_phase_in_sec: int = 15
    tracking_plausibility_factor_x: float = 4.0
    tracking_plausibility_factor_y: float = 2.5
    tracking_plausibility_check: bool = False
